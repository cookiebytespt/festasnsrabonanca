...
- `index.html` — página única (programa, comissão, merchandising). HTML, CSS e JS inline, sem dependências além das fontes Google.
...
O programa está diretamente no `index.html` (uma `<section class="panel">` por dia, com `<li class="ev">` por evento). Basta editar o texto e fazer commit.
